...
";
    ...
    {
        return array (  210 => 48,  200 => 47,  181 => 8,  164 => 69,  158 => 66,  153 => 64,  148 => 62,  144 => 61,  131 => 50,  129 => 47,  122 => 43,  105 => 29,  93 => 20,  89 => 19,  85 => 18,  81 => 17,  77 => 16,  70 => 12,  66 => 11,  62 => 10,  58 => 9,  54 => 8,  45 => 1,);
    }
...
<nav class=\"navbar navbar-dark navbar-expand-lg fixed-top bg-white portfolio-navbar gradient\" style=\"font-family: Lato, sans-serif;transform: perspective(0px);filter: hue-rotate(310deg) invert(0%);\">
    <div class=\"container\"><a class=\"navbar-brand logo\" href=\"{{ path('home') }}\" style=\"filter: blur(0px) grayscale(100%) hue-rotate(360deg);\">Mathéo Balens</a><button data-bs-toggle=\"collapse\" class=\"navbar-toggler\" data-bs-target=\"#navbarNav\"><span class=\"visually-hidden\">Toggle navigation</span><span class=\"navbar-toggler-icon\"></span></button>
        <div class=\"collapse navbar-collapse\" id=\"navbarNav\">
            <ul class=\"navbar-nav ms-auto\">
                <li class=\"nav-item\"></li>
                <li class=\"nav-item\"></li>
        ...
        </div><button class=\"btn-primary btn-sm\" type=\"button\" style=\"text-decoration:none; filter: hue-rotate(75deg);\"><a class=\"text-center\" href=\"{{ path('contact') }}\" style=\"text-decoration:none;color: rgb(255,255,255);font-size: 16px;border-bottom-style: none;\">Contactez moi !</a></button>
    </div>
</nav>
